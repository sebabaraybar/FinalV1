...
namespace FinalV1.Controllers
{
    public class MenuController : Controller
    {
        ...
        public async Task<IActionResult> Index(string nameFilter)
        {
            ...
            {
                query = query.Where(m => m.Name.ToLower().Contains(nameFilter.ToLower()));
            }
            var restaurants = query.Include(r => r.Restaurants).Select(r => r.Restaurants).ToList();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var menu = await _context.Menu.Include(m => m.Restaurants)
